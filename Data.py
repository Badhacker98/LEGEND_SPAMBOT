...
class Data:
    HELP_MENU1 = [
        ...
        [
            ...
            InlineKeyboardButton(text="💫 ᴇᴠᴀʟ 💫", callback_data="evaluators_help1"),
            ],
         [
         ...
         [
            InlineKeyboardButton(
                text="💫 ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ 💫", callback_data="gwish_help1"
            ),
        ...
        [
            InlineKeyboardButton(text="✨ ʀᴀɪᴅ ✨", callback_data="raid_help1"),
        ...
        [
            ...
            InlineKeyboardButton(text="✨ ᴜ sᴘᴀᴍ ✨", callback_data="unlimited_help1"),
          ],
            [
